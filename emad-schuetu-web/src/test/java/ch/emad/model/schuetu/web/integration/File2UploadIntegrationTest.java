...
import ch.emad.model.schuetu.web.FileUploadController;
...
@Transactional
public class File2UploadIntegrationTest {

    private static final Logger LOG = Logger.getLogger(File2UploadIntegrationTest.class);
