...
//public class FindColorPattern extends MarvinAbstractImagePlugin {
    /**
     ...
     public static MarvinAttributes attributes = null;
     ...
     FindColorPattern s = new FindColorPattern();
     s.load();
     MarvinImage imageIn = MarvinImageIO.loadImage("/res/m3.png");
     MarvinImage imageOut = MarvinImageIO.loadImage("/res/m3.png");
     s.process(imageIn, imageOut, FindColorPattern.attributes, null, true);

     MarvinImageIO.saveImage(imageOut, "/res/m66.png");
     }
     ...
     @Override public MarvinAttributesPanel getAttributesPanel() {
